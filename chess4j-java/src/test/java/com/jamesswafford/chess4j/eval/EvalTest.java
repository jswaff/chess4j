...
//        testCaseSymmetry("7r/R6p/2K4P/5k1P/2p4n/5p2/8/8 w - - 0 1");
        testCaseSymmetry("8/4K3/8/1N6/6p1/4k2p/8/8 w - - 0 1");
...
//        }
    ...
    public void testKK() {
        ...
        assertEquals(0, eval(weights, board));
    ...
    private void testCaseSymmetry(String fen) {
        ...
        System.out.println("fen: " + fen + " eval: " + eval1);
        board.flipVertical();
        System.out.println("flipped:");
        DrawBoard.drawBoard(board);
        int eval2 = eval(myWeights, board);
        System.out.println("fen: " + fen + " eval1: " + eval1 + " eval2: " + eval2);
