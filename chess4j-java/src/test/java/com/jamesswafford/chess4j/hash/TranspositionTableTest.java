...
public class TranspositionTableTest {
    ...
    public void testStoreCapture() {
        ...
        Move capture = MoveGeneratorImpl.genLegalMoves(board).stream()
    ...
    public void testStorePromotion() {
        ...
        Move promotion = MoveGeneratorImpl.genLegalMoves(board).stream()
    ...
    public void testStoreCastle() {
        ...
        Move castle = MoveGeneratorImpl.genLegalMoves(board).stream()
    ...
    public void testStoreEPCapture() {
        ...
        Move epCapture = MoveGeneratorImpl.genLegalMoves(board).stream()
