...
public class ExtendTest {
    ...
    public void testPassedPawn1() throws Exception {
        ...
        assertTrue(MoveGen.genLegalMoves(b).contains(e4));
        b.applyMove(e4);

        assertEquals(0, Extend.extendDepth(b, e4));
    }
    ...
    public void testExtendPromotion() throws Exception {
        ...
        assertEquals(1, Extend.extendDepth(b, m));
    }
    ...
    public void testPassedPawn7() throws Exception {
        ...
        assertTrue(MoveGen.genLegalMoves(b).contains(a5));
        b.applyMove(a5);

        assertEquals(0, Extend.extendDepth(b, a5));
    }
    ...
    public void testPassedPawn8() throws Exception {
        ...
        assertTrue(MoveGen.genLegalMoves(b).contains(f6));
        b.applyMove(f6);

        assertEquals(0, Extend.extendDepth(b, f6));
    }
    ...
    public void testRecapture() throws Exception {
        ...
        assertTrue(MoveGen.genLegalMoves(b).contains(m2));
        b.applyMove(m2);

        assertEquals(1, Extend.extendDepth(b, m2));
    }
    ...
    public void testRecapture3() throws Exception {
        ...
        assertEquals(0, Extend.extendDepth(b, m2));
    }
