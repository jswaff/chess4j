...
public class EPDParserTest {
    ...
    public void setPosTest1() throws ParseException {
        ...
        Assert.assertEquals(King.BLACK_KING, b.getPiece(Square.H8));
        Assert.assertEquals(Rook.BLACK_ROOK, b.getPiece(Square.G5));
        Assert.assertEquals(Pawn.WHITE_PAWN, b.getPiece(Square.G3));
