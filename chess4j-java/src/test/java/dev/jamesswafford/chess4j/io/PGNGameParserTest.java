...
public class PGNGameParserTest {
    ...
    public void testSimplePGN() {
        ...
        moves.add(new MoveWithNAG(new Move(Pawn.WHITE_PAWN, Square.E2, Square.E4), null));
        moves.add(new MoveWithNAG(new Move(Pawn.BLACK_PAWN, Square.E7, Square.E5), "{what a move!}"));
