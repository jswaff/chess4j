...
public class HypothesisTest {
    ...
    public void sigmoidTest() {
        ...
        assertDoubleEquals(Hypothesis.texelSigmoid(Constants.CHECKMATE), 1);
        assertDoubleEquals(Hypothesis.texelSigmoid(-Constants.CHECKMATE), 0);
    }
