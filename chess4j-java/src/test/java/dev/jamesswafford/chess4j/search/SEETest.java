...
public class SEETest {
    ...
    public void testQueenTakesUndefendedPawn() {
        ...
        Move move = new Move(Queen.WHITE_QUEEN, Square.B3, Square.B6, Pawn.BLACK_PAWN);
    ...
    public void testRookTakesUndefendedPawn() {
        ...
        Move move = new Move(Rook.WHITE_ROOK, Square.E1, Square.E5, Pawn.BLACK_PAWN);
    ...
    public void testWithXrays() {
        ...
        Move move = new Move(Knight.WHITE_KNIGHT, Square.D3, Square.E5, Pawn.BLACK_PAWN);
    ...
    public void testRookXRays() {
        ...
        Move move = new Move(Rook.WHITE_ROOK, Square.E3, Square.E6 , Pawn.BLACK_PAWN);
