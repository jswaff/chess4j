...
public class AlphaBetaSearchTest {
    ...
    public void search_initialPos_depth1() {
        ...
        SearchParameters params = new SearchParameters(1, -Constants.CHECKMATE, Constants.CHECKMATE);
        ...
        board1.applyMove(new Move(Pawn.WHITE_PAWN, Square.E2, Square.E4));
        when(evaluator.evaluateBoard(board1)).thenReturn(3);

        Board board2 = new Board();
        board2.applyMove(new Move(Knight.WHITE_KNIGHT, Square.B1, Square.C3));
        ...
        Assert.assertEquals(new Move(Knight.WHITE_KNIGHT, Square.B1, Square.C3), search.getPv().get(0));
    }
    ...
    public void mateIn1() {
        ...
        SearchParameters params = new SearchParameters(2, -Constants.CHECKMATE, Constants.CHECKMATE);
        ...
        assertEquals(new Move(Queen.WHITE_QUEEN, Square.D6, Square.E7), pv.get(0));
    }
    ...
    public void mateIn1b() {
        ...
        List<Move> pv = search.getPv();
        assertEquals(1, pv.size());
        assertEquals(new Move(Queen.BLACK_QUEEN, Square.G5, Square.E7), pv.get(0));
    }
    ...
    public void mateIn2() {
        ...
        SearchParameters params = new SearchParameters(4, -Constants.CHECKMATE, Constants.CHECKMATE);
        ...
        assertEquals(new Move(Queen.WHITE_QUEEN, Square.D2, Square.H6), pv.get(0));
        assertEquals(new Move(King.BLACK_KING, Square.G7, Square.H6, Queen.WHITE_QUEEN), pv.get(1));
        assertEquals(new Move(Bishop.WHITE_BISHOP, Square.H4, Square.F6, Pawn.BLACK_PAWN), pv.get(2));
    }
    ...
    public void mateIn3() {
        ...
        SearchParameters params = new SearchParameters(6, -Constants.CHECKMATE, Constants.CHECKMATE);
        ...
        assertEquals(new Move(Rook.WHITE_ROOK, Square.F6, Square.A6), pv.get(0));
        assertEquals(new Move(Pawn.BLACK_PAWN, Square.F7, Square.F6), pv.get(1));
        assertEquals(new Move(Bishop.WHITE_BISHOP, Square.E5, Square.F6, Pawn.BLACK_PAWN), pv.get(2));
        assertEquals(new Move(Rook.BLACK_ROOK, Square.G8, Square.G7), pv.get(3));
        assertEquals(new Move(Rook.WHITE_ROOK, Square.A6, Square.A8, Rook.BLACK_ROOK), pv.get(4));
    }
    ...
    public void alphaBetaCutoffs() {
        ...
        SearchParameters params = new SearchParameters(3, -Constants.CHECKMATE, Constants.CHECKMATE);
        ArgumentCaptor<Board> boardCaptor = ArgumentCaptor.forClass(Board.class);

        // from position A we need three moves.  It doesn't matter what the moves
        // are as long as they are legal.
        Move e2e3 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E3);
        Move e2e4 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E4);
        Move d2d4 = new Move(Pawn.WHITE_PAWN, Square.D2, Square.D4);
        ...
        Move d7d5 = new Move(Pawn.BLACK_PAWN, Square.D7, Square.D5);
        Move d7d6 = new Move(Pawn.BLACK_PAWN, Square.D7, Square.D6);
        ...
        Move b2b3 = new Move(Pawn.WHITE_PAWN, Square.B2, Square.B3);
        Move b2b4 = new Move(Pawn.WHITE_PAWN, Square.B2, Square.B4);
        ...
        Move c2c3 = new Move(Pawn.WHITE_PAWN, Square.C2, Square.C3);
        Move c2c4 = new Move(Pawn.WHITE_PAWN, Square.C2, Square.C4);
        ...
        Move c7c5 = new Move(Pawn.BLACK_PAWN, Square.C7, Square.C5);
        Move c7c6 = new Move(Pawn.BLACK_PAWN, Square.C7, Square.C6);
        ...
        Move a2a3 = new Move(Pawn.WHITE_PAWN, Square.A2, Square.A3);
        ...
        Move g7g5 = new Move(Pawn.BLACK_PAWN, Square.G7, Square.G5);
        Move g7g6 = new Move(Pawn.BLACK_PAWN, Square.G7, Square.G6);
        ...
        Move h2h4 = new Move(Pawn.WHITE_PAWN, Square.H2, Square.H4);
        Move h2h3 = new Move(Pawn.WHITE_PAWN, Square.H2, Square.H3);
        ...
        Move b1c3 = new Move(Knight.WHITE_KNIGHT, Square.B1, Square.C3);
        Move b1a3 = new Move(Knight.WHITE_KNIGHT, Square.B1, Square.A3);
        ...
        Assert.assertEquals(e2e3, search.getPv().get(0));
        Assert.assertEquals(d7d5, search.getPv().get(1));
        Assert.assertEquals(b2b4, search.getPv().get(2));
    }
    ...
    public void stopSearch() {
        ...
        Future<Integer> future = executor.submit(() -> search.search(new Board(),
                new SearchParameters(8, -Constants.CHECKMATE, Constants.CHECKMATE)));
    ...
    public void stoppedSearchDoesNotReturnPV() {
        ...
        search.search(new Board(), new SearchParameters(1, -Constants.CHECKMATE, Constants.CHECKMATE));
        assertEquals(1, search.getPv().size());
    ...
    public void lastPvIsTriedFirst() {
        ...
        Board board = new Board();
        search.search(board, new SearchParameters(1, -Constants.CHECKMATE, Constants.CHECKMATE));
        ...
        for (int depth=2; depth <= 6; depth++) {
            search.search(board, new SearchParameters(depth, -Constants.CHECKMATE, Constants.CHECKMATE), opts);
