...
public class SQLiteBookTest {
    ...
    public void addMove() {
        ...
        Assert.assertEquals(e2e4,bookMove.getMove());
    ...
    public void addMoveTwice() {
        ...
        BookMove bookMove = bookMoves.get(0);
        Assert.assertEquals(d2d4,bookMove.getMove());
    ...
    public void addIllegalMove() {
        ...
        Move illegal = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E5);
...
Be5 41.Rd2 Bc6 42.b5 Bf3 43.Bf4 1-0
        ...
        List<BookMove> bookMoves = book.getMoves(board);
        assertEquals(1, bookMoves.size());
        Assert.assertEquals(mp.parseMove("f4", board),bookMoves.get(0).getMove());
        board.applyMove(bookMoves.get(0).getMove());

        bookMoves = book.getMoves(board);
        assertEquals(1, bookMoves.size());
        Assert.assertEquals(mp.parseMove("e5", board),bookMoves.get(0).getMove());
        board.applyMove(bookMoves.get(0).getMove());

        bookMoves = book.getMoves(board);
        assertEquals(1, bookMoves.size());
        Assert.assertEquals(mp.parseMove("fxe5", board),bookMoves.get(0).getMove());
        board.applyMove(bookMoves.get(0).getMove());

        bookMoves = book.getMoves(board);
        assertEquals(1, bookMoves.size());
        Assert.assertEquals(mp.parseMove("d6", board),bookMoves.get(0).getMove());
        board.applyMove(bookMoves.get(0).getMove());

        bookMoves = book.getMoves(board);
        assertEquals(1, bookMoves.size());
        Assert.assertEquals(mp.parseMove("exd6", board),bookMoves.get(0).getMove());
        board.applyMove(bookMoves.get(0).getMove());
    }
