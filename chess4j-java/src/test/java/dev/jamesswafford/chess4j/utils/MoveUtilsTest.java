...
public class MoveUtilsTest {
    ...
    public void testMoveToTopList() {
        Move m1 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E3);
        Move m2 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E4);
        Move m3 = new Move(Pawn.WHITE_PAWN, Square.A2, Square.A3);
        Move m4 = new Move(Knight.WHITE_KNIGHT, Square.G1, Square.F3);
    ...
    public void testSwapList() {
        Move m0 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E3);
        Move m1 = new Move(Pawn.WHITE_PAWN, Square.E2, Square.E4);
        Move m2 = new Move(Pawn.WHITE_PAWN, Square.A2, Square.A3);
        Move m3 = new Move(Knight.WHITE_KNIGHT, Square.G1, Square.F3);
    ...
    public void testIndexOfList() {
        ...
        Assert.assertEquals(-1,MoveUtils.indexOf(moves, new Move(Pawn.WHITE_PAWN, Square.C2, Square.C4), 0));
    }
