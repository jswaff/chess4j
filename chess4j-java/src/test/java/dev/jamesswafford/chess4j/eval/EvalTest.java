...
public class EvalTest {
    ...
    public void testStartPosIs0() {
        int eval = Eval.eval(weights, new Board());
        assertEquals(0, eval);
    }
    ...
    public void testKK() {
        ...
        Assert.assertEquals(0, Eval.eval(weights, board));
    ...
    public void testKNKP() {
        ...
        Board board = new Board(fen);
        int eval = Eval.eval(weights, board);
    ...
    private void testCaseSymmetry(String fen) {
        ...
        int eval1 = Eval.eval(myWeights, board);
        board.flipVertical();
        int eval2 = Eval.eval(myWeights, board);
