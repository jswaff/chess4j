...
public class FileTest {
    ...
    @Test
    public void west() {
        assertFalse(File.FILE_A.west().isPresent());
    ...
    public void east() {
        ...
        assertFalse(File.FILE_H.east().isPresent());
    }

    @Test
    public void westOf() {
        assertTrue(File.FILE_A.westOf(File.FILE_B));
        assertTrue(File.FILE_C.westOf(File.FILE_G));
        assertFalse(File.FILE_D.westOf(File.FILE_D));
        assertFalse(File.FILE_E.westOf(File.FILE_B));
    }

    @Test
    public void eastOf() {
        assertTrue(File.FILE_B.eastOf(File.FILE_A));
        assertTrue(File.FILE_G.eastOf(File.FILE_C));
        assertFalse(File.FILE_D.eastOf(File.FILE_D));
        assertFalse(File.FILE_B.eastOf(File.FILE_E));
    }
