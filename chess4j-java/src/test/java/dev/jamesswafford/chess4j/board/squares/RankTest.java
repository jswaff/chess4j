...
public class RankTest {
    ...
    @Test
    public void north() {
        assertFalse(Rank.RANK_8.north().isPresent());
    ...
    public void south() {
        ...
        assertFalse(Rank.RANK_1.south().isPresent());
    }

    @Test
    public void northOf() {
        assertTrue(Rank.RANK_8.northOf(Rank.RANK_1));
        assertTrue(Rank.RANK_7.northOf(Rank.RANK_5));
        assertFalse(Rank.RANK_4.northOf(Rank.RANK_4));
        assertFalse(Rank.RANK_3.northOf(Rank.RANK_6));
    }

    @Test
    public void southOf() {
        assertTrue(Rank.RANK_1.southOf(Rank.RANK_8));
        assertTrue(Rank.RANK_5.southOf(Rank.RANK_7));
        assertFalse(Rank.RANK_4.southOf(Rank.RANK_4));
        assertFalse(Rank.RANK_6.southOf(Rank.RANK_3));
    }
