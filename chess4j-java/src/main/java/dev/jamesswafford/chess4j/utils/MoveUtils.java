    ...
    private static Piece fromNativePiece(int pieceType, Color pieceColor) {
        ...
        switch (pieceType) {
            case 0:
                return null;
            case 1:
                return isWhite ? Pawn.WHITE_PAWN : Pawn.BLACK_PAWN;
            case 2:
                return isWhite ? Knight.WHITE_KNIGHT : Knight.BLACK_KNIGHT;
            case 3:
                return isWhite ? Bishop.WHITE_BISHOP : Bishop.BLACK_BISHOP;
            case 4:
                return isWhite ? Rook.WHITE_ROOK : Rook.BLACK_ROOK;
            case 5:
                return isWhite ? Queen.WHITE_QUEEN : Queen.BLACK_QUEEN;
            case 6:
                return isWhite ? King.WHITE_KING : King.BLACK_KING;
            default:
