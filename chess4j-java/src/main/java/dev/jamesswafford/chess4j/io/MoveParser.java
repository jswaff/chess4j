    ...
    private Move getCastlingMove() {
        if (strMove.equalsIgnoreCase("O-O") || strMove.equals("0-0")) {
            if (board.getPlayerToMove().equals(Color.WHITE)) {
                return new Move(King.WHITE_KING, Square.E1, Square.G1, true);
            } else {
                return new Move(King.BLACK_KING, Square.E8, Square.G8, true);
            }
        } else if (strMove.equalsIgnoreCase("O-O-O") || strMove.equals("0-0-0")) {
            if (board.getPlayerToMove().equals(Color.WHITE)) {
                return new Move(King.WHITE_KING, Square.E1, Square.C1, true);
            } else {
                return new Move(King.BLACK_KING, Square.E8, Square.C8, true);
            }
        }
        return null;
    }
