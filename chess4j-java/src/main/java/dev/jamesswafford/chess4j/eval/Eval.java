...
public final class Eval implements Evaluator {
    ...
    private static int evalHelper(EvalWeights weights, Board board, boolean materialOnly, boolean strict) {
        ...
        // eval kings
        Tuple2<Integer, Integer> wKingScore = EvalKing.evalKing(weights, board, board.getKingSquare(Color.WHITE));
        Tuple2<Integer, Integer> bKingScore = EvalKing.evalKing(weights, board, board.getKingSquare(Color.BLACK));
    ...
    public static double[] extractFeatures(Board board) {
        ...
        EvalMaterial.extractMaterialFeatures(features, board);
        ...
        EvalKing.extractKingFeatures(features, board, board.getKingSquare(Color.WHITE), phase);
        EvalKing.extractKingFeatures(features, board, board.getKingSquare(Color.BLACK), phase);
