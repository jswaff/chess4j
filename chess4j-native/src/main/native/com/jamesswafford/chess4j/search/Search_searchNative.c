 ...
 * Method:    searchNative
 * Signature: (Ljava/util/List;Ljava/util/List;IIILcom/jamesswafford/chess4j/search/v2/SearchStats;)I
 */
JNIEXPORT jint JNICALL Java_com_jamesswafford_chess4j_search_v2_Search_searchNative
  (JNIEnv *env, jobject UNUSED(search_obj), jobject prev_moves,
...

{
    ...
    for (int i=0; i<size; i++)
    {
        ...
        /* apply this move */
        apply_move(&pos, (move_t) prev_mv, undos + pos.move_counter);
