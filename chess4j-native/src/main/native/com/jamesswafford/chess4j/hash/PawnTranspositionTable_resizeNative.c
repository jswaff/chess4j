 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_jamesswafford_chess4j_hash_PawnTranspositionTable_resizeNative
  (JNIEnv *env, jobject UNUSED(phtable), jint size_bytes)
{
    ...
    int retval = resize_hash_table(&phtbl, (uint32_t) size_bytes);
    if (0 != retval)
    {
